...
document.addEventListener('DOMContentLoaded', function () {
	...
	function check() {
		var mySearch = document.querySelector('.wiki-app__keyword');

		if (mySearch.value) {
			var keyword = mySearch.value,
			...
			var _query = 'https://en.wikipedia.org/w/api.php?action=query&format=json&origin=*&prop=info&generator=random&inprop=url&grnnamespace=&grnlimit=1';

			getJSON(_query, clickSearch, error);
		}
	}
